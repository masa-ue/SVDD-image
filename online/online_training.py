...
targets = torch.load('model/pre_generated_scores-15360.pth')
encoded_imgs = torch.load('model/pre_generated_latents-15360.pth')

assert targets.shape[0] == encoded_imgs.shape[0]
...
for epoch in tqdm(range(num_epochs), desc="Epoch"):
    ...
    torch.save(model, f'model/online/reward_predictor_epoch_{epoch}.pth')
